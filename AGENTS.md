...
**版本**：v0.1.6
**日期**：2026-08-07
**状态**：✅ 已审查批准（v0.1.0 用户 2026-08-07 批准；v0.1.1 治理资产清单同步更新；v0.1.2 省察修复 + §11.4 交叉审查元纪律；v0.1.3 §3.1 同步 01-TRD v0.2.2 决策 6；v0.1.4 §10 补全 M0 pnpm 命令；v0.1.5 §3.1 同步 00-索引 v0.1.24/04-Todo v0.1.9；v0.1.6 §3.1 同步 00-索引 v0.1.25/04-Todo v0.1.11 T-M0-007 done）
...
| 文档 | 版本 | 权威范围 |
|---|---|---|
| [00-文档索引](./docs/00-文档索引-Index.md) | v0.1.27 | 文档导航 + 门禁 + 版本历史 |
...
| [04-Todo](./docs/04-任务清单-Todo-List.md) | v0.1.15 | 任务登记 + 组件治理看板 + 里程碑 M0-M3 + §6.0 M0 完成说明 |
