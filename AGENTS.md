...
| 文档 | 版本 | 权威范围 |
|---|---|---|
| [00-文档索引](./docs/00-文档索引-Index.md) | v0.1.161 | 文档导航 + 门禁 + 版本历史 + M5 用户验收阶段状态 + 任务启动提示词资产索引 |
...
| [04-Todo](./docs/04-任务清单-Todo-List.md) | v0.1.158 | 任务登记 + 组件治理看板 + 里程碑 M0-M5；T-M5-001 用户验收审计 in_progress，T-M5-002~008 pending；不启动其他 M5 任务。 |
...
| `.plan/` | ✅ 已就绪 | 任务计划目录（历史计划保留为证据；当前唯一执行计划为 `.plan/T-M5-001-ui-acceptance-audit.md`） |
| `.record/` | ✅ 已就绪 | 实施记录目录（历史记录已就绪；当前任务记录为 `.record/T-M5-001-实施记录.md`，记录真实安装审计、验证、审查与未解决边界） |
