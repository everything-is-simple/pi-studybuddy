...
| 文档 | 版本 | 权威范围 |
|---|---|---|
| [00-文档索引](./docs/00-文档索引-Index.md) | v0.1.65 | 文档导航 + 门禁 + 版本历史 |
...
| [04-Todo](./docs/04-任务清单-Todo-List.md) | v0.1.58 | 任务登记 + 组件治理看板 + 里程碑 M0-M3 + §6.0 M0 完成说明 + §6.3 M1 退出门槛全通过 + §6.4 M2 退出门槛全通过 + §7.2.1 M1 任务登记表 + §7.3.1 M2 任务登记表 + §7.4.1 M3 任务登记表 + §7.5 全局执行顺序表 |
