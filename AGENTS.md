...
| 文档 | 版本 | 权威范围 |
|---|---|---|
| [00-文档索引](./docs/00-文档索引-Index.md) | v0.1.175 | 文档导航 + 门禁 + 版本历史 + M5 用户验收阶段状态 + 任务启动提示词资产索引 |
...
| [04-Todo](./docs/04-任务清单-Todo-List.md) | v0.1.177 | 任务登记 + 组件治理看板 + 里程碑 M0-M5；T-M5-001/002/003 done，T-M5-004 in_progress（用户已授权 Git 收口，功能已合并 master 且 master 质量门通过；正在执行远端推送核验），T-M5-005~008 pending；每任务用户端到端测试铁律已登记。 |
