...
**版本**：v0.1.2
**日期**：2026-08-07
**状态**：✅ 已审查批准（v0.1.0 用户 2026-08-07 批准；v0.1.1 治理资产清单同步更新；v0.1.2 省察修复 + §11.4 交叉审查元纪律）
...
| 文档 | 版本 | 权威范围 |
|---|---|---|
| [00-文档索引](./docs/00-文档索引-Index.md) | v0.1.17 | 文档导航 + 门禁 + 版本历史 |
| [01-TRD](./docs/01-TRD-技术需求-Technical-Requirements.md) | v0.2.1 | 技术底座决策 + 五点定案 |
