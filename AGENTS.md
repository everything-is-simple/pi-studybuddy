...
| 文档 | 版本 | 权威范围 |
|---|---|---|
| [00-文档索引](./docs/00-文档索引-Index.md) | v0.1.177 | 文档导航 + 门禁 + 版本历史 + M5 用户验收阶段状态 + 测试与运维规范批准/任务登记 |
...
| [04-Todo](./docs/04-任务清单-Todo-List.md) | v0.1.179 | 任务登记 + 组件治理看板 + 里程碑 M0-M5；T-M5-001~004 done，T-M5-009 pending（测试与运维追溯基线），T-M5-005~008 pending；每任务用户端到端测试铁律已登记。 |
