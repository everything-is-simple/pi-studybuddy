...
| 文档 | 版本 | 权威范围 |
|---|---|---|
| [00-文档索引](./docs/00-文档索引-Index.md) | v0.1.174 | 文档导航 + 门禁 + 版本历史 + M5 用户验收阶段状态 + 任务启动提示词资产索引 |
...
| [04-Todo](./docs/04-任务清单-Todo-List.md) | v0.1.176 | 任务登记 + 组件治理看板 + 里程碑 M0-M5；T-M5-001/002/003 done，T-M5-004 in_progress（v4c 原生 UAT、完整质量门与双独立复审 A/B 已通过；仅 Git 收口待用户授权），T-M5-005~008 pending；每任务用户端到端测试铁律已登记。 |
