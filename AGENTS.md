...
**版本**：v0.1.142
**日期**：2026-08-15
**状态**：📝 M5 进行中（v0.1.142：T-M5-010「设置、投递、学期备份与数据根迁移闭环」已完成实现、自动化、隔离原生 UAT 与独立审查，正按用户授权执行 Git 收口；T-M5-005 仍 blocked，仅等待其既定三条干净 Windows 原生 UAT；T-M5-006~008 不启动，当前工作区不读取、不暂存安装器。）
