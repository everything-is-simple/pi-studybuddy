...
### 3.1 设计文档（docs/00-09，全部 ✅ 已审查批准；13 为待审查测试与运维草案）

| 文档 | 版本 | 权威范围 |
|---|---|---|
| [00-文档索引](./docs/00-文档索引-Index.md) | v0.1.182 | 文档导航 + 门禁 + 版本历史 + M5 用户验收阶段状态 + 测试与运维规范批准/任务登记 |
...
| [04-Todo](./docs/04-任务清单-Todo-List.md) | v0.1.183 | 任务登记 + 组件治理看板 + 里程碑 M0-M5；T-M5-001~004 done，T-M5-009 pending（测试与运维追溯基线），T-M5-005~008 pending；每任务用户端到端测试铁律已登记。 |
...
| [13-测试与运维](./docs/13-测试与运维-Testing-and-Operations.md) | ✅ v0.1.1 已审查批准 | 用户动作、错误责任、数据资产/SQLite 生命周期、真实测试、真机 UAT、发布与运维门禁；T-M5-009 负责首次追溯基线，仍待单独开工授权。 |
...
| `docs/traceability/` | 📝 T-M5-009 in_progress | 六项测试与运维追溯基线资产；不新增业务 API/schema/handler/入口 |
