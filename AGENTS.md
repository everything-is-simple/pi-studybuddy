...
| 文档 | 版本 | 权威范围 |
|---|---|---|
| [00-文档索引](./docs/00-文档索引-Index.md) | v0.1.176 | 文档导航 + 门禁 + 版本历史 + M5 用户验收阶段状态 + 任务启动提示词资产索引 |
...
| [04-Todo](./docs/04-任务清单-Todo-List.md) | v0.1.178 | 任务登记 + 组件治理看板 + 里程碑 M0-M5；T-M5-001~004 done（T-M5-004 已获授权、已合并/复验/推送核验完成），T-M5-005~008 pending；每任务用户端到端测试铁律已登记。 |
...
| [13-测试与运维](./docs/13-测试与运维-Testing-and-Operations.md) | 📝 v0.1.0 草案 | 用户动作、错误责任、数据资产/SQLite 生命周期、真实测试、真机 UAT、发布与运维门禁；待用户审查批准。 |
