...
| 45 | T-M5-005 | M5 | S6/S7/TTS/备份/设置与整体 UX 修订 | T-M5-001 + T-M5-002 | P0：补齐完整闭环、真实状态和桌面可用性 |
| 46 | T-M5-006 | M5 | 必需运行依赖自包含与离线能力装配 | T-M5-001；可与 002-005 的已裁决修订并行 | P0：目标机不依赖开发环境或人工装组件 |
| 47 | T-M5-007 | M5 | 干净 Windows 已安装应用全功能 UAT | T-M5-002~006 | P0：真实用户、真实安装产物、全控件与故障恢复签收 |
| 48 | T-M5-008 | M5 | setup + portable zip 最终发行验收 | T-M5-007 | P0：只在 UAT 全通过后生成最终一键交付物 |
