...
| T-M3-007 | E2E-10~13（对话默认主入口/工具调用/@引用/TTS+L3检索） | 测试 | P1 | in_progress | 阶段5 | 08-Test §6.5 | 计划 .plan/T-M3-007-e2e-chat.md — 对话承载（agent.send/sessions.*/modelsConfig.*）入 E2E 子进程 test-main.js + agent.events 事件推送 + RpcDriver waitForEvent + 4 个 E2E 文件（E2E-10~13） |
