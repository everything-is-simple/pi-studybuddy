...
| T-M1-005 | OCR venv Adapter（课表图片识别） | 业务Adapter | P1 | pending | 阶段2-3 | 03-Arch §3.3 + 08-Test §3.3 | — |
...
| T-M1-010 | E2E-01~03（学期初始化/资料笔记/练习→错题→薄弱点） | 测试 | P1 | pending | 阶段5 | 08-Test §6.1 | — |
