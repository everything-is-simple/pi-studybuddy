...
**版本**：v0.1.2（T-M5-011：开发机优先真实闭环整改）
**日期**：2026-08-15
...
所有影响“系统正常运行”的已知问题，包含 `04-Todo` 未完成任务和历史任务暴露的跨链路缺口，统一记录在 [系统集成三份文件](./docs/系统集成/01-系统集成总览与客观认知.md)；其中问题总账为 [02-系统问题总账与整改清单](./docs/系统集成/02-系统问题总账与整改清单.md)，验收路径为 [03-系统集成验收与交付路径](./docs/系统集成/03-系统集成验收与交付路径.md)。当前按“开发机真实闭环 → 固化运行资源 → 复制到使用机 → 重建安装包”推进。
